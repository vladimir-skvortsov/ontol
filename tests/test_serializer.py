...
def sample_ontology():
    ...
    ontology.add_function(Function(name="MyFunction", input_types=["int"], output_types=["bool"], description="A sample function"))
    ontology.add_relationship(Relationship(expression="A > B"))
    ontology.set_meta(Meta(version="1.0", name="SampleOntology", author="Author", description="Sample description", date_created="2024-01-01"))
    return ontology
...
def test_serialize_function(serializer):
    func = Function(name="TestFunction", input_types=["int"], output_types=["str"], description="A test function")
...
def test_serialize_ontology_without_meta(serializer):
    ...
    ontology.add_function(Function(name="MyFunction", input_types=["int"], output_types=["bool"]))
    ontology.add_relationship(Relationship(expression="A > B"))
