...
def mock_ontology():
    ontology = Ontology()
    ontology.set_meta(Meta(version="1.0", name="TestOntology", author="Author", description="Test ontology", date_created="2024-01-01"))
    ontology.add_type(Term(name="MyType", description="A test type"))
    ontology.add_function(Function(name="MyFunction", input_types=["int", "str"], output_types=["bool"], description="Test function"))
...
def test_generate_function(generator):
    func = Function(name="MyFunction", input_types=["int"], output_types=["bool"], description="Test function")
